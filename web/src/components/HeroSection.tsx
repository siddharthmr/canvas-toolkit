    ...
    <section className="relative w-full overflow-hidden -mt-[4.5rem] sm:-mt-20">
        <div className="flex flex-col items-center pt-28 sm:pt-32">
            ...
            <h1 className="hero-heading text-center select-none px-6">
                <span className="hero-heading-ghost block mb-2 md:mb-4">
                ...
                <div className="flex flex-col items-center">
                    <div className="flex flex-col sm:flex-row gap-3">
                        <a
                            ...
                            className="inline-flex items-center justify-center gap-2.5 bg-[#000] text-[#E5E5E5] pl-5 pr-6 py-2.5 rounded-lg text-sm font-medium tracking-tight hover:bg-[#222] transition-colors duration-200 border border-[#E5E5E5]/10"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center justify-center gap-2.5 bg-[#000] text-[#E5E5E5] pl-5 pr-6 py-2.5 rounded-lg text-sm font-medium tracking-tight border border-[#E5E5E5]/10 hover:bg-[#222] hover:border-[#E5E5E5]/20 transition-all duration-200"
                        >
