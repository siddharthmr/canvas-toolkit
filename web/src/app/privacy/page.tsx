...
const PrivacyPolicyPage = () => {
    return (
        <div className="flex flex-col min-h-screen bg-black text-[rgb(220,220,220)]">
            <Navbar />
            <main className="flex-grow container mx-auto px-6 py-8">
                <div className="bg-black/30 backdrop-blur-md rounded-lg p-8 border border-[rgb(35,35,35)]">
                    <h1 className="text-3xl font-bold mb-6">Privacy Policy for CanvasToolkit</h1>
                    ...
                    <ul className="list-disc list-inside mb-4 pl-4 space-y-1">
                        ...
                        <li>
                            <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to CanvasToolkit.
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>Website</strong> refers to CanvasToolkit, accessible from{' '}
                            <a href="https://canvastoolkit.com" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:underline">
                                canvastoolkit.com
                            </a>
                        </li>
                        <li>
                    ...
                    <h3 className="text-xl font-semibold mt-4 mb-2">Tracking Technologies and Cookies</h3>
                    ...
                    <ul className="list-disc list-inside mb-4 pl-4 space-y-3">
                        <li>
                            <p>
                    ...
                    <p className="mb-4">We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>You can lear
                    ...
                    <ul className="list-disc list-inside mb-4 pl-4 space-y-1">
                        <li>By email: c.viperdevelopment@gmail.com</li>
                    </ul>
                </div>
            </main>
            <FooterSection />
